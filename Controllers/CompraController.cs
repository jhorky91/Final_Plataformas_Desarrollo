...
namespace Final_Plataformas_De_Desarrollo.Controllers
{
    public class CompraController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("idCompra,idUsuario,total")] Compra compra)
        {
            ...
            ViewData["idUsuario"] = new SelectList(_context.usuarios, "idUsuario", "apellido", compra.idUsuario);
            return View(compra);
        }
